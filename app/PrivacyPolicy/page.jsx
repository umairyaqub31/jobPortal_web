...
export default function PrivacyPolicy() {
  return (
    <div className="mr-[100px] ml-[100px] mt-[30px] mb-[50px] text-start">
      <p className="text-[40px] font-semibold  text-[#3f6eec]">
        {" "}
        Privacy Policy for Hireon
      </p>
      <p className="text-[24px] mt-5  font-semibold ">Privacy Policy</p>
      <p className="text-[24px] mt-2  font-semibold text-[#CBC5C4]">
        Privacy Policy Last updated: May 14, 2024
      </p>
      ...
      <p className="text-[16px] mt-2 ">
        <strong>Interpretation:</strong> The words of which the initial letter
      ...
      <p className="text-[16px] mt-2 font-semibold ">Definitions</p>
      ...
      <p className="text-[16px] mt-2 ">
        ...
        this Agreement) refers to Hireon.
      </p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Country refers to: Haryana, India.</p>
      <p className="text-[16px] mt-2 ">
        Device means any device that can access the Service such as a computer,
        a cellphone or a digital tablet.
      </p>

      <p className="text-[16px] mt-2 "></p>
      ...
      <p className="text-[16px] mt-5 font-semibold ">
      ...
      <p className="text-[16px] mt-2 ">
        Website refers to Hireon, accessible from{" "}
        <a className="text-[#72E8E4]" href="https://hireon.co.in/.">
          https://hireon.co.in/.
        </a>
      </p>
      <p className="text-[16px] mt-2 ">
        ...
        using the Service, as applicable. a
      </p>

      <p className="text-[16px] mt-2 ">
        Collecting and Using Your Personal DataCollecting and Using Your
        Personal Data
      </p>

      <p className="text-[16px] mt-2 ">Types of Data Collected</p>
      <p className="text-[16px] mt-2 ">Personal Data</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Email address</p>
      <p className="text-[16px] mt-2 ">First name and last name</p>
      <p className="text-[16px] mt-2 ">Phone number</p>
      <p className="text-[16px] mt-2 ">
        Address, State, Province, ZIP/Postal code, City
      </p>
      <p className="text-[16px] mt-5 font-semibold ">Usage Data</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Necessary / Essential Cookies s</p>
      <p className="text-[16px] mt-2 ">Type: Session Cookies</p>
      <p className="text-[16px] mt-2 ">Administered by: U</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Type: Persistent Cookies</p>
      <p className="text-[16px] mt-2 ">Administered by: Us</p>
      <p className="text-[16px] mt-2 ">
        Purpose: These Cookies identify if users have accepted the use of
        cookies on the Website.
      </p>
      <p className="text-[16px] mt-5 font-text ">Functionality Cookies</p>
      <p className="text-[16px] mt-2 ">Type: Persistent Cookies</p>
      <p className="text-[16px] mt-2 ">Administered by: Us </p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Use of Your Personal Data</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-5 font-semibold ">Usage Data</p>
      <p className="text-[16px] mt-2 ">Transfer of Your Personal Data</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Disclosure of Your Personal Data</p>
      <p className="text-[16px] mt-5 font-semibold ">Business Transactions</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-5 font-semibold ">Law enforcement</p>
      ...
      <p className="text-[16px] mt-2 ">Comply with a legal obligation</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Protect against legal liability</p>
      <p className="text-[16px] mt-2 ">Security of Your Personal Data</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-5 font-semibold ">Children's Privacy</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-5 font-semibold ">Links to Other Websites</p>
      <p className="text-[16px] mt-2 ">
      ...
      <p className="text-[16px] mt-2 ">Contact Us</p>

      <p className="text-[16px] mt-2 ">
        If you about this Privacy Policy, You can contact us:have any questions{" "}
      </p>
      <p className="text-[16px] mt-2 ">
        By email:<a href="HIreon.bd@gmail.com">HIreon.bd@gmail.com</a>{" "}
      </p>
    </div>
  );
}
